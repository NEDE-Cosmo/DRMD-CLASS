...
cdef class Class:
    ...
    @property
    def f_drmd(self):
      """Return the fractional energy density in DRMD at early times (dimensionless)."""
      self.compute(["background"])
      return CallableFloat(self.ba.f_drmd)
    @property
    def z_dec_drmd(self):
      """Return the redshift of DRMD decoupling."""
      self.compute(["background"])
      return CallableFloat(self.ba.z_dec_drmd)
    @property
    def rs_d_drmd(self):
      """Return the DRMD/DAO drag horizon."""
      self.compute(["background"])
      return CallableFloat(self.ba.rs_d_drmd)
    @property
    def T_cmb(self):
